...
import cateBathProducts  from  '../assets/categoryImage/cat-bathproducts.png'
...
const categoryData = [
  {
    cardHeading: "Sink",
    cardImage: cateBathProducts
  },
  {
    cardHeading: "Wash Basin",
    cardImage: cateBathProducts
  },
  {
    cardHeading: "Lights 1",
    cardImage: cateBathProducts
  },
  {
    cardHeading: "Category 2",
    cardImage: cateBathProducts
  }
]
...
function BathProductsCollection() {
  const data = [1,2,3,4,5,6,7,8]
  return (
    <main id="main-wrapper--frontend-bathproductcollection">
      <StickyHeader />
      <HeroBanner 
...
export default BathProductsCollection